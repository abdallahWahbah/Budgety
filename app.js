//  we will make 3 modules, eaches module doesn't know anything about the other one, it can't access any variable or method from the outside
var budgetController = (function () // Module 1    // anonymous function (IIFE)
{
  ...
  return { // only what is inside can be accesed by other modules
    ...
    deleteItem: function (type, id) {
      ...
      if (index != -1) {
        data.allItems[type].splice(index, 1); // remove an item at the index, 1 is how many items to delete from the index.....just delete the item
      }
    },
    calculateBudget: function () {
      // Calculate total income and exposes
      calculateTotal("exp");
      calculateTotal("inc");
